...
public class EntityFrameworkStoreRepository : IStoreRepository
{
    ...
    public EntityFrameworkStoreRepository(BonusSystemContext dbContext, ILogger<EntityFrameworkStoreRepository> logger)
    {
    ...
    public async Task<bool> AddSellerToStoreAsync(Guid storeId, Guid sellerId)
    {
        try
        {
            ...
            var exists = await _dbContext.StoreSellerAssignments.AnyAsync(
            ...
            var assignment = new StoreSellerAssignmentEntity()
            {
                Id = Guid.NewGuid(),
                StoreId = storeId,
                UserId = sellerId,
            ...
            await _dbContext.StoreSellerAssignments.AddAsync(assignment);
            await _dbContext.SaveChangesAsync();
    ...
    public async Task<bool> RemoveSellerFromStoreAsync(Guid storeId, Guid sellerId)
    {
        try
        {
            ...
            _dbContext.StoreSellerAssignments.Remove(assignment);
            await _dbContext.SaveChangesAsync();
    ...
    public async Task<IEnumerable<UserDto>> GetSellersByStoreIdAsync(Guid storeId)
    {
        try
        {
            var sellerIds = await _dbContext.StoreSellerAssignments
