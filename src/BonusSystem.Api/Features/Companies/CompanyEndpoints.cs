    ...
    public static WebApplication MapCompanyEndpoints(this WebApplication app)
    {
        ...
        group.MapGet("/context", CompanyHandlers.GetUserContext)
            ...
            .WithOpenApi(operation => 
            {
                ...
                operation.Description = "Retrieves the current company user's context information including profile data and permitted actions. This is typically called after login to initialize the company's dashboard.\n\n" +
        ...
        group.MapPost("/stores", CompanyHandlers.RegisterStore)
            ...
            .WithOpenApi(operation => 
            {
                ...
                operation.Description = "Creates a new store associated with the company. New stores are set to 'PendingApproval' status until approved by an administrator.\n\n" +
                    "Request requires:\n" +
        ...
        group.MapPost("/sellers", CompanyHandlers.RegisterSeller)
            ...
            .WithOpenApi(operation => 
            {
                ...
                operation.Description = "Creates a new seller user associated with the company. Sellers are store employees who can process transactions with buyers.\n\n" +
                    "Request requires:\n" +
        ...
        group.MapGet("/statistics", CompanyHandlers.GetStatistics)
            ...
            .WithOpenApi(operation => 
            {
                ...
                operation.Description = "Retrieves dashboard statistics for the company, including bonus circulation, current active bonus, transaction count, and store information.\n\n" +
                    "Query parameters:\n" +
        ...
        group.MapGet("/transactions", CompanyHandlers.GetTransactionSummary)
            ...
            .WithOpenApi(operation => 
            {
                ...
                operation.Description = "Retrieves a summary of transactions for the company. This includes the most recent transaction details that help the company monitor bonus point activity.\n\n" +
